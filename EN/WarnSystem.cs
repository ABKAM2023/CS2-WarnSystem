...
namespace WarnSystemPlugin
{
    public class AWarnSystemPlugin : BasePlugin
    {
        ...
        public class PluginConfig
        {
            ...
            public string BanReason { get; set; } = "Multiple Warnings";
            public string BanMessage { get; set; } = "[{Red}ADMIN{White}] Player {Red}{PlayerName}{White} has been banned for multiple warnings.";
            public string WarningMessage { get; set; } = "[{Red}ADMIN{White}] Player {Red}{PlayerName}{White} has received a warning. Current number of warnings: {Red}{Warnings}{White}. Warnings remaining until ban: {Red}{WarningsLeft} {White}warnings.";
            public string WarningCenterMessage { get; set; } = "<font color='red' class='fontSize-l'>You have received a warning. You now have {Warnings} warnings. Warnings remaining until a ban: {WarningsLeft} warnings.</font>";
            public string WarningsClearedMessage { get; set; } = "<font color='green' class='fontSize-l'>Your warnings have been cleared.</font>";
            public string AdminWarningsClearedMessage { get; set; } = "[{Red}ADMIN{White}] Player {Green}{PlayerName}{White}'s warnings have been cleared.";
            public string NoWarningsMessage { get; set; } = "[{Red}ADMIN{White}] Player {Green}{PlayerName}{White} has no warnings.";
        }
